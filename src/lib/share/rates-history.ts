...
function decompressState(
    ...
    return {
        ...
        updatesFilter: {
            ...
            changeType: (compressed.u.c ??
                "all") as UpdatesFilter["changeType"],
        },
        ...
        trendsFilter: {
            ...
            buyerCategory: (compressed.r.b ??
                "pdh") as TrendsFilter["buyerCategory"],
            ...
            breakdownBy: (compressed.r.g ?? [
                "lender",
            ]) as TrendsBreakdownDimension[],
