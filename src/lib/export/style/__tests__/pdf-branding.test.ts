...
describe("PDF_COLORS", () => {
	...
	describe("text colors", () => {
		it("has text color (dark)", () => {
			...
			const brightness =
				(PDF_COLORS.text[0] + PDF_COLORS.text[1] + PDF_COLORS.text[2]) / 3;
	...
	describe("semantic colors", () => {
		it("has success color (green-ish)", () => {
			...
			expect(PDF_COLORS.success[1]).toBeGreaterThan(PDF_COLORS.success[0]);
			expect(PDF_COLORS.success[1]).toBeGreaterThan(PDF_COLORS.success[2]);
		});
...
describe("PDF_LAYOUT", () => {
	...
	describe("spacing", () => {
		...
		it("section gap is larger than paragraph gap", () => {
			expect(PDF_LAYOUT.sectionGap).toBeGreaterThan(PDF_LAYOUT.paragraphGap);
		});
	});
