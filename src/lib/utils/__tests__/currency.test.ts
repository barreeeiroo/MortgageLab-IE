...
describe("formatCurrency", () => {
    ...
    describe("with showCents option", () => {
        ...
        it("formats decimal values with cents", () => {
            expect(formatCurrency(1234.56, { showCents: true })).toBe(
                "€1,234.56",
            );
        });
        ...
        it("handles negative with cents", () => {
            expect(formatCurrency(-123.45, { showCents: true })).toBe(
                "-€123.45",
            );
        });
    });
...
describe("formatCurrencyInput", () => {
    ...
    describe("allowZero option", () => {
        ...
        it("formats non-zero values normally with allowZero", () => {
            expect(formatCurrencyInput("1000", { allowZero: true })).toBe(
                "€1,000",
            );
        });
...
describe("formatCurrencyFromCents", () => {
    ...
    describe("with showCents option", () => {
        ...
        it("formats small cent values", () => {
            expect(formatCurrencyFromCents(99, { showCents: true })).toBe(
                "€0.99",
            );
        });
    });
