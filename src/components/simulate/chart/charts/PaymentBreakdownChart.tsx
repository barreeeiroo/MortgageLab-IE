...
export function PaymentBreakdownChart({
	...
	const shouldAverage = visibility.monthlyAverage && granularity !== "monthly";
									...
									<div className="flex items-center justify-between gap-4">
										<div className="flex items-center gap-1.5">
											<div
												...
												style={{ backgroundColor: CHART_COLORS.principal }}
											/>
										...
										<span className="font-mono font-medium text-sm">
											{formatChartCurrency(dataPoint.monthlyPrincipal)}
										</span>
									</div>
									<div className="flex items-center justify-between gap-4">
										<div className="flex items-center gap-1.5">
											<div
												className="h-2.5 w-2.5 rounded-sm shrink-0"
												style={{ backgroundColor: CHART_COLORS.interest }}
											/>
											<span className="text-muted-foreground text-sm">
												Interest
											</span>
										...
										<span className="font-mono font-medium text-sm">
											{formatChartCurrency(dataPoint.monthlyInterest)}
										</span>
									</div>
										...
										<div className="flex items-center justify-between gap-4">
											<div className="flex items-center gap-1.5">
												<div
													className="h-2.5 w-2.5 rounded-sm shrink-0"
													style={{
														backgroundColor: CHART_COLORS.oneTimeOverpayment,
													}}
												/>
												<span className="text-muted-foreground text-sm">
											...
											<span className="font-mono font-medium text-sm">
												{formatChartCurrency(dataPoint.oneTimeOverpayment)}
											</span>
										</div>
									)}
										...
										<div className="flex items-center justify-between gap-4">
											<div className="flex items-center gap-1.5">
												<div
													className="h-2.5 w-2.5 rounded-sm shrink-0"
													style={{
														backgroundColor: CHART_COLORS.recurringOverpayment,
													}}
												/>
												<span className="text-muted-foreground text-sm">
											...
											<span className="font-mono font-medium text-sm">
												{formatChartCurrency(dataPoint.recurringOverpayment)}
											</span>
										</div>
									)}
									<div className="pt-1 mt-1 border-t border-border/50">
										<div className="flex items-center justify-between gap-4">
											<span className="text-muted-foreground text-sm font-medium">
												{shouldAverage ? "Monthly Total" : "Total Payment"}
											</span>
											<span className="font-mono font-medium text-sm">
												{formatChartCurrency(totalPayment)}
											</span>
										</div>
									</div>
								</div>
