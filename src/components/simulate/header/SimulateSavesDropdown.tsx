...
export function SimulateSavesDropdown() {
    ...
    const selectionCount =
        compareState.savedIds.length +
        (compareState.includeCurrentView ? 1 : 0);
                                ...
                                <>
                                    <div className="relative flex items-center gap-2 px-2 py-1.5">
                                        <Checkbox
                                            id="compare-current"
                                            checked={
                                                compareState.includeCurrentView
                                            }
                                            onCheckedChange={
                                                handleToggleCurrentForCompare
                                            }
                                            disabled={
                                                !compareState.includeCurrentView &&
                                                !canAddMore
                                ...
                                >
                                    {compareMode ? (
                                        <>
                                            <Checkbox
                                                id={`compare-${save.id}`}
                                                checked={compareState.savedIds.includes(
                                                    save.id,
                                                )}
                                                onCheckedChange={() =>
                                                    handleToggleSaveForCompare(
                                                        save.id,
                                                    )
                                                }
                                                disabled={
                                                    !compareState.savedIds.includes(
                                                        save.id,
                                                    ) && !canAddMore
                                                }
                                                className="ml-1"
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            {selectedSave?.name}"? This action cannot be undone.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button
