...
export function SimulateEmptyState() {
    ...
    return (
        <div data-simulate-empty-state data-hidden={shouldHide}>
            {!shouldHide && (
                <Card
                    className="border-dashed mt-6"
                    data-testid="simulate-empty-state"
                >
                    <CardHeader className="text-center pb-2">
                        ...
                        <CardDescription>
                            To simulate a mortgage, first select a rate from our
                            comparison table. You can then model different
                            scenarios with overpayments and rate changes.
                        </CardDescription>
                    </CardHeader>
