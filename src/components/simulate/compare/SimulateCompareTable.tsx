                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        {COMPARE_TABLE_COLUMNS.map((col) => (
                            <Toggle
                                ...
                                onPressedChange={() =>
                                    toggleCompareTableColumn(col.key)
                                }
                                size="sm"
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        {simulations.map((sim) => (
                            <Toggle
                                ...
                                onPressedChange={() =>
                                    toggleCompareTableSimulation(sim.id)
                                }
                                size="sm"
                                className="h-7 gap-1.5 text-xs cursor-pointer hover:bg-muted data-[state=on]:bg-accent"
                            >
                        ...
                        <TableBody>
                            ...
                            {displayedSimulations.length > 0 && (
                                <TableRow className="bg-muted/50 font-medium border-t-2">
                                    ...
                                    {/* Interest totals */}
                                    {visibleColumns.interest &&
                                        displayedSimulations.map(
                                            (sim, simIndex) => {
                                                const total =
                                                    sim.summary.totalInterest;
                                                const baseTotal =
                                                    baseSimulation?.summary
                                                        .totalInterest;
                                                const diff =
                                                    simIndex > 0
                                                        ? formatDiff(
