					...
					<div className="grid grid-cols-2 gap-4">
						<div className="space-y-1">
							...
							<Select
								...
								onValueChange={(v) =>
									handleCalendarChange(Number(v), calendarValues.monthOfYear)
								}
							>
						...
						<div className="space-y-1">
							...
							<Select
								...
								onValueChange={(v) =>
									handleCalendarChange(calendarValues.year, Number(v))
								}
							>
								<SelectTrigger id="cal_month" className="w-full">
									<SelectValue />
								</SelectTrigger>
								<SelectContent>
					...
					<div className="grid grid-cols-2 gap-4">
						<div className="space-y-1">
							...
							<Select
								...
								onValueChange={(v) =>
									handleDurationChange(Number(v), durationMonths)
								}
							>
								<SelectTrigger id="dur_years" className="w-full">
									<SelectValue />
								</SelectTrigger>
								<SelectContent>
						...
						<div className="space-y-1">
							...
							<Select
								...
								onValueChange={(v) =>
									handleDurationChange(durationYears, Number(v))
								}
							>
								<SelectTrigger id="dur_months" className="w-full">
									<SelectValue />
								</SelectTrigger>
								<SelectContent>
