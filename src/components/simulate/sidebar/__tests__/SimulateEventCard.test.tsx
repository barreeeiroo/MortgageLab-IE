...
describe("SimulateRatePeriodEvent", () => {
    ...
    describe("popover content", () => {
        ...
        it("shows Until end of mortgage for 0 duration", async () => {
            ...
            expect(
                screen.getByText("Until end of mortgage"),
            ).toBeInTheDocument();
        });
    ...
    describe("warnings", () => {
        ...
        it("shows warning messages in popover", async () => {
            ...
            expect(
                screen.getByText("Exceeds 10% allowance"),
            ).toBeInTheDocument();
        });
    });
    ...
    describe("action buttons", () => {
        it("shows Edit button when onEdit is provided", async () => {
            ...
            const onEdit = vi.fn();
            render(
                <SimulateRatePeriodEvent {...defaultProps} onEdit={onEdit} />,
            );
...
describe("SimulateMilestoneEvent", () => {
    ...
    describe("milestone types", () => {
        ...
        it("renders construction_complete milestone", () => {
            ...
            expect(
                screen.getByText("Construction Complete"),
            ).toBeInTheDocument();
        });
