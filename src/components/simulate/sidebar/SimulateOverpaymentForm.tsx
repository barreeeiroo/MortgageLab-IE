		...
		<>
			...
			<div className="space-y-2">
				...
				<Select
					...
					disabled={isEditing}
				>
					<SelectTrigger className={`w-full ${isEditing ? "opacity-60" : ""}`}>
				...
				{!isEditing && isFixedPeriod && (
					<div className="flex items-start gap-2 text-xs text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/30 rounded-md p-2">
						...
						<p>
							This is a fixed rate period. Consider using the Maximize tab for
							optimal fee-free overpayments.
						</p>
					</div>
				)}
			</div>
			...
			{type === "recurring" && setFrequency && (
				<div className="space-y-2">
					...
					>
						...
						<div className="flex items-center space-x-2">
							<RadioGroupItem value="quarterly" id="freq_quarterly" />
							<Label
