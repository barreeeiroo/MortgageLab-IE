...
export function SimulateTimingSelector({
    ...
    const endCalendarMonthOptions = endCalendarValues
        ...
        : [];
    const startDurationMonthOptions =
        getDurationMonthOptions(startDurationYears);
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    {endCalendarMonthOptions.length >
                                                    0
                                                        ? endCalendarMonthOptions.map(
                                                              (m) => (
                                                                  <SelectItem
                                                                      key={m}
                                                                      value={String(
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    {endDurationMonthOptions.length >
                                                    0
                                                        ? endDurationMonthOptions.map(
                                                              (m) => (
                                                                  <SelectItem
                                                                      key={m}
                                                                      value={String(
