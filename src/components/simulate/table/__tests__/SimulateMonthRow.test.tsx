...
describe("SimulateMonthRow", () => {
    ...
    describe("overpayment display", () => {
        ...
        it("shows overpayment amount when present", () => {
            const monthWithOverpayment = createMockMonth({
                overpayment: 50000,
            }); // €500
            renderInTable(
                <SimulateMonthRow
    ...
    describe("warnings", () => {
        it("applies warning styling when warnings present", () => {
            ...
            renderInTable(
                <SimulateMonthRow {...defaultProps} warnings={warnings} />,
            );
    ...
    describe("formatting", () => {
        it("formats large currency amounts correctly", () => {
            ...
            renderInTable(
                <SimulateMonthRow {...defaultProps} month={largeMonth} />,
            );
        ...
        it("handles zero values", () => {
            ...
            renderInTable(
                <SimulateMonthRow {...defaultProps} month={zeroMonth} />,
            );
