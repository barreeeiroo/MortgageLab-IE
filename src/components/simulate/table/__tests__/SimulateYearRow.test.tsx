...
describe("SimulateYearRow", () => {
    ...
    describe("interaction", () => {
        it("calls onToggle when row is clicked", async () => {
            ...
            renderInTable(
                <SimulateYearRow {...defaultProps} onToggle={onToggle} />,
            );
        ...
        it("shows expand icon when collapsed", () => {
            renderInTable(
                <SimulateYearRow {...defaultProps} isExpanded={false} />,
            );
        ...
        it("shows collapse icon when expanded", () => {
            renderInTable(
                <SimulateYearRow {...defaultProps} isExpanded={true} />,
            );
    ...
    describe("expanded state", () => {
        ...
        it("shows rate changes when expanded and present", () => {
            ...
            const yearWithRateChanges = createMockYear({
                rateChanges: ["period-1"],
            });
            renderInTable(
                <SimulateYearRow
                    {...defaultProps}
            ...
            expect(
                screen.getByText(/AIB 3 Year Fixed @ 3\.45%/),
            ).toBeInTheDocument();
        });
    ...
    describe("warnings", () => {
        it("applies warning styling when allowance exceeded warnings present", () => {
            ...
            renderInTable(
                <SimulateYearRow {...defaultProps} warnings={warnings} />,
            );
    ...
    describe("formatting", () => {
        it("formats large currency amounts correctly", () => {
            ...
            renderInTable(
                <SimulateYearRow {...defaultProps} year={largeYear} />,
            );
