...
export function ManageCustomRatesDialog({
    ...
    const [editingRate, setEditingRate] = useState<StoredCustomRate | null>(
        null,
    );
                        ...
                        {customRates.length === 0 ? (
                            <div className="px-6 py-12 text-center text-muted-foreground">
                                ...
                                <p className="text-xs mt-1">
                                    Add a custom rate to compare against lender
                                    rates.
                                </p>
                            </div>
                        ) : (
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            {deleteConfirmRate?.name}"? This action cannot be
                            undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
