...
describe("LenderSelector", () => {
	...
	describe("basic rendering", () => {
		it("renders placeholder when nothing selected", () => {
			render(
				<LenderSelector lenders={mockLenders} value={[]} onChange={vi.fn()} />,
			);
	...
	describe("single select mode", () => {
		...
		it("calls onChange with selected lender", async () => {
			...
			render(
				<LenderSelector lenders={mockLenders} value={[]} onChange={onChange} />,
			);
			...
			await user.click(screen.getByRole("menuitemcheckbox", { name: /AIB/i }));
	...
	describe("multiple select mode", () => {
		...
		it("calls onChange with toggled selection", async () => {
			...
			await user.click(
				screen.getByRole("menuitemcheckbox", { name: /Bank of Ireland/i }),
			);
