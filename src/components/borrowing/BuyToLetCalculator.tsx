            ...
            <Card>
                <CardContent>
                    <div className="mb-6">
                        ...
                        <CardDescription>
                            For investment or second properties without selling
                            your current home. Enter your deposit, income, and
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                        ...
                                        <Tooltip>
                                            ...
                                            <TooltipContent className="max-w-xs">
                                                <p>
                                                    ...
                                                    stress-test at ~
                                                    {(
                                                        STRESS_TEST_RATE * 100
                                                    ).toFixed(1)}
                                                    % and require rent to cover{" "}
                                                    {(
                                                        RENTAL_COVERAGE_RATIO *
                                                        100
                                                    ).toFixed(0)}
                                                    % of the payment. These are
                                                    common lender requirements,
                                                    not Central Bank rules.
                                                </p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </TooltipProvider>
                                ...
                                />
                                <p className="text-xs text-muted-foreground">
                                    Research comparable rental properties in the
                                    area.
                                </p>
                            </div>
                        </div>
                        ...
                        {isAnyAgeTooOld && (
                            <p className="text-sm text-destructive">
                                Applicants must be{" "}
                                {AGE_LIMITS.MAX_APPLICANT_AGE} years old or
            ...
            >
                <AlertDialogContent className="sm:max-w-5xl">
                    <AlertDialogHeader>
                        ...
                        {calculationResult?.constrainedBy === "rental" && (
                            <AlertDialogDescription>
                                Your maximum mortgage is limited by expected
                                rental income. Based on your deposit, you could
                                borrow up to{" "}
                                <strong>
                                    {formatCurrency(
                                        (parseCurrency(deposit) /
                                            (1 - BTL_MAX_LTV)) *
                                            BTL_MAX_LTV,
                                    )}
                                </strong>
                                , but rental coverage requirements limit you to
                                the amount shown below.
                            </AlertDialogDescription>
                        )}
                        {calculationResult?.constrainedBy === "income" && (
                            <AlertDialogDescription>
                                Your maximum mortgage is limited by income
                                (LTI). Based on your deposit, you could borrow
                                up to{" "}
                                <strong>
                                    {formatCurrency(
                                        (parseCurrency(deposit) /
                                ...
                                , but income limits restrict you to the amount
                                shown below.
                            </AlertDialogDescription>
                        )}
                    </AlertDialogHeader>
                    <AlertDialogBody>
                        {calculationResult && (
                            <MortgageResultCard
                                ...
                                isConstrained={
                                    calculationResult.constrainedBy !==
                                    "deposit"
                                }
                                ...
                                additionalMetrics={
                                    <>
                                        ...
                                        <div>
                                            ...
                                            <p
                                                className={`text-lg font-semibold ${coverageColor}`}
                                            >
                                                {calculationResult.result.rentalCoverage.toFixed(
                                                    0,
                                                )}
                                                %
                                            </p>
                                ...
                                additionalSections={
                                    <div className="pt-4 border-t border-border mt-4">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-2">
                                            Most lenders require rent to cover
                                            at least{" "}
                                            {(
                                                RENTAL_COVERAGE_RATIO * 100
                                            ).toFixed(0)}
                                            % of the mortgage payment at a
                                            stress-tested rate of ~
                                            {(STRESS_TEST_RATE * 100).toFixed(
                                                1,
                                            )}
                                            %. These are typical lender
                                            requirements, not Central Bank
                                            rules.
                                        </p>
                                    </div>
                                }
