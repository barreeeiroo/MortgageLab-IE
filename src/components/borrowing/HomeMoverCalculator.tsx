...
export function HomeMoverCalculator() {
    ...
    useEffect(() => {
        ...
        if (saved.additionalSavings)
            setAdditionalSavings(saved.additionalSavings);
            ...
            <Card>
                <CardContent>
                    <div className="mb-6">
                        ...
                        <CardDescription>
                            For homeowners selling their current property and
                            buying a new primary residence. Enter your income,
                            property details, and any additional savings.
                        </CardDescription>
                    </div>
                    ...
                    <div className="space-y-6">
                        <ApplicantInputs
                            ...
                            incomeNote={
                                <>
                                    ...
                                    allows {MOVER_LTI_LIMIT}× income for
                                    second/subsequent buyers. Lenders can exceed
                                    this for {LENDER_ALLOWANCES.MOVER}% of their
                                    lending. Some may include overtime, bonuses,
                                    or other income.
                                </>
                            }
                        />
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            >
                                Self Build (selling current home and building on
                                land you own)
                            </Label>
                        </div>
                        ...
                        {isSelfBuild ? (
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-muted-foreground">
                                    Any extra savings beyond your property
                                    equity. Exclude Stamp Duty and legal fees.
                                </p>
                            </div>
                        )}
                    ...
                    <AlertDialogHeader>
                        ...
                        {calculationResult?.hasDepositShortfall && (
                            <AlertDialogDescription>
                                ...
                                <strong>
                                    {formatCurrency(
                                        calculationResult.maxMortgageByIncome ??
                                            0,
                                    )}
                                </strong>
                                , but you would need{" "}
                                <strong>
                                    {formatCurrency(
                                        calculationResult.requiredDeposit ?? 0,
                                    )}
                                </strong>{" "}
                                for a 10% deposit. The figures below are
                                adjusted based on your available funds (equity +
                                savings).
                            </AlertDialogDescription>
                        )}
                    </AlertDialogHeader>
