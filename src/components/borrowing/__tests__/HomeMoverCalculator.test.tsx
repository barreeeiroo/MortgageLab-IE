...
describe("HomeMoverCalculator", () => {
    ...
    describe("form rendering", () => {
        ...
        it("renders calculator description for home movers", () => {
            ...
            expect(
                screen.getByText(
                    /For homeowners selling their current property/,
                ),
            ).toBeInTheDocument();
        });
        ...
        it("renders outstanding mortgage input", () => {
            ...
            expect(
                screen.getByLabelText("Outstanding Mortgage"),
            ).toBeInTheDocument();
        });
    ...
    describe("equity display", () => {
        it("shows equity calculation when property value and mortgage entered", async () => {
            ...
            await waitFor(() => {
                expect(
                    screen.getByText(/Equity from sale:/),
                ).toBeInTheDocument();
            });
        });
        ...
        it("does not show negative equity", async () => {
            ...
            await waitFor(() => {
                expect(
                    screen.queryByText(/Equity from sale:/),
    ...
    describe("self-build mode", () => {
        ...
        it("includes site value in total deposit calculation", async () => {
            ...
            await user.type(
                screen.getByLabelText("Additional Savings"),
                "50000",
            );
