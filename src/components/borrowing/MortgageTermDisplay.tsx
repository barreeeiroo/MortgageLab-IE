    ...
    return (
        <div className="space-y-2">
                ...
                <TooltipProvider>
                    <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                            <p>
                                Some lenders may offer mortgage terms of up to
                                40 years, depending on your age and
                                circumstances.
                            </p>
                        </TooltipContent>
                    </Tooltip>
            ...
            <p className="text-xs text-muted-foreground">
                Based on a maximum age of {AGE_LIMITS.MAX_AGE_AT_END} at the end
                of term. Some lenders may extend to age{" "}
