...
export function FirstTimeBuyerCalculator() {
    ...
    const calculate = useCallback(() => {
        ...
        const hasSavingsShortfall =
            totalDeposit < requiredDepositForMaxMortgage;
            ...
            <Card>
                <CardContent>
                    <div className="mb-6">
                        ...
                        <CardDescription>
                            Enter your income and savings to see the maximum
                            mortgage you could get as a first time buyer.
                        </CardDescription>
                    </div>
                    ...
                    <div className="space-y-6">
                        <ApplicantInputs
                            ...
                            incomeNote={
                                <>
                                    ...
                                    allows {FTB_LTI_LIMIT}× income for
                                    first-time buyers. Lenders can exceed this
                                    for {LENDER_ALLOWANCES.FTB}% of their
                        ...
                        {isAnyAgeTooOld && (
                            <p className="text-sm text-destructive">
                                ...
                                younger to qualify for a first time buyer
                                mortgage.
                            </p>
                        )}
                    ...
                    <AlertDialogHeader>
                        ...
                        {calculationResult?.hasSavingsShortfall && (
                            <AlertDialogDescription>
                                ...
                                in savings for a 10% deposit. The figures below
                                are adjusted based on your current savings.
                            </AlertDialogDescription>
                        )}
                    </AlertDialogHeader>
                    <AlertDialogBody>
