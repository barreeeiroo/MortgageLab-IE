...
describe("PropertyTypeSelector", () => {
    ...
    describe("options", () => {
        ...
        it("calls onChange when selection changes", async () => {
            ...
            render(
                <PropertyTypeSelector {...defaultProps} onChange={onChange} />,
            );
    ...
    describe("VAT toggle", () => {
        ...
        it("shows VAT toggle for new build", () => {
            render(
                <PropertyTypeSelector {...defaultProps} value="new-build" />,
            );

            expect(
                screen.getByLabelText("Price includes VAT"),
            ).toBeInTheDocument();
        });
    ...
    describe("custom props", () => {
        it("uses custom id when provided", () => {
            render(
                <PropertyTypeSelector {...defaultProps} id="custom-property" />,
            );
