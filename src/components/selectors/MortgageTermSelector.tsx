...
export function MortgageTermSelector({
    ...
    const combobox = (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent
                className="p-0 w-[200px] md:w-[300px]"
                align="start"
            >
                {/* Mode Toggle */}
                <div className="p-2 border-b">
                    <Tabs
                        value={
                            effectiveWithMonths ? "with-months" : "years-only"
                        }
                        onValueChange={(v) =>
                            handleToggleMode(v === "with-months")
                        }
                        className="w-full"
                    >
                ...
                <div
                    className={cn(
                        effectiveWithMonths ? "flex flex-col md:flex-row" : "",
                    )}
                >
                            ...
                            <div className="p-2 border-t">
                                <div className="flex gap-1">
                                    ...
                                    <Button
                                        ...
                                        disabled={
                                            customMonths === "" ||
                                            Number.parseInt(customMonths, 10) <
                                                0 ||
                                            Number.parseInt(customMonths, 10) >
                                                11
                                        }
                    ...
                    <div
                        className={cn(
                            "flex-1",
                            effectiveWithMonths && "md:order-1",
                        )}
                    >
                        <div className="p-1">
                            {optional && (
