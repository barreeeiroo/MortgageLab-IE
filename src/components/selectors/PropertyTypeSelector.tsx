...
export function PropertyTypeSelector({
    ...
    const selector = (
        <Select
            value={value}
            onValueChange={(v) => onChange(v as PropertyType)}
        >
            <SelectTrigger
                id={id}
            ...
            <TooltipProvider>
                <Tooltip>
                    ...
                    <TooltipContent className="max-w-xs">
                        <p>
                            New build prices are usually advertised with VAT
                            included. Uncheck if you have a VAT-exclusive price
                            (e.g., from a contract).
                        </p>
                    </TooltipContent>
                </Tooltip>
