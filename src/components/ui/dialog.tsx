		...
		<DialogPortal data-slot="dialog-portal">
			...
			<div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden p-4">
				<DialogPrimitive.Content
					...
					className={cn(
						"bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 relative grid w-full max-h-full max-w-lg gap-4 rounded-lg border p-6 shadow-lg duration-200 outline-none",
						className,
					)}
					{...props}
				>
