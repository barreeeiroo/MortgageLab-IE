...
export function RateInfoModal({
    ...
    const handleSimulate = (
        ...
        const propertyValueCents = Math.round(
            (mortgageAmount / ltv) * 100 * 100,
        );
        ...
        const followOn =
            includeFollowOn && !repeatMode && calculations?.followOnRate
                ? {
                      ...
                      isCustom:
                          (calculations.followOnRate as { isCustom?: boolean })
                              .isCustom ?? false,
                      label: generateRateLabel(
                          lenderName,
                          calculations.followOnRate,
                      ),
                  }
                : undefined;
        ...
        if (mode === "first-mortgage") {
            ...
            if (canRepeat) {
                ...
                options.push({
                    ...
                    description:
                        "Add this rate and repeat without variable buffers",
                    icon: <Repeat className="h-4 w-4" />,
                        ...
                        <div className="flex items-start justify-between gap-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <DialogDescription>
                                        {(rate as { customLenderName?: string })
                                            .customLenderName ??
                                            lender?.name ??
                                            rate.lenderId}{" "}
                                        •{" "}
                ...
                <div className="flex-1 overflow-y-auto px-6 pb-6 pt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-4">
                            ...
                            {isFixed &&
                                calculations.remainingBalance !== undefined && (
                                    <div>
                                        <h4 className="text-sm font-semibold text-muted-foreground mb-2">
                            ...
                            (simulateOptions.length > 1 ? (
                                <div className="flex items-center">
                                    <Button
                                        className="gap-1.5 rounded-r-none"
                                        onClick={() =>
                                            handleSimulateWithConfirm(true)
                                        }
                                    >
                                        <Play className="h-4 w-4" />
                                        Simulate
                    ...
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="space-y-3">
                            <span className="block">
                                Mortgage switches are typically a continuation
                                of an existing mortgage.
                            </span>
                            <span className="block">
                                To model a switch: on this page, select{" "}
                                <strong>First Mortgage</strong> and click{" "}
                                <strong>Simulate</strong> to create a simulation
                                with your current mortgage. Then, on the
                                Simulate page, click <strong>Add Rate</strong>{" "}
                                and the <strong>Add to Simulation</strong>{" "}
                                button will appear here when clicking on a
                                remortgage product.
                            </span>
                        </AlertDialogDescription>
                    </AlertDialogHeader>
