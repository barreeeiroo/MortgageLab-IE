        ...
        <TooltipProvider>
            <div className="mb-3">
                <Tabs
                    value={mode}
                    onValueChange={(value) =>
                        updateField("mode", value as RatesMode)
                    }
                >
                    <TabsList>
                        <TabsTrigger value="first-mortgage">
                            First Mortgage
                        </TabsTrigger>
                        <TabsTrigger value="remortgage">
                            Mortgage Switch
                        </TabsTrigger>
                    </TabsList>
                </Tabs>
                ...
                <Card className="bg-blue-500/10 border-blue-500/30">
                    <CardContent className="py-3 flex items-center gap-3">
                        ...
                        <p className="text-sm text-blue-600 dark:text-blue-400">
                            Enter your property details above to compare
                            mortgage rates from Irish lenders.
                        </p>
                    </CardContent>
                </Card>
            )}
