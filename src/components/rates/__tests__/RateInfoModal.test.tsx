...
describe("RateInfoModal", () => {
    ...
    describe("mortgage details section", () => {
        ...
        it("displays monthly repayments", () => {
            ...
            expect(
                screen.getAllByText("Monthly Repayments").length,
            ).toBeGreaterThan(0);
            // Check that currency values are displayed
            expect(
                screen.getAllByText(/€[\d,]+\.\d{2}/).length,
            ).toBeGreaterThan(0);
        });
    ...
    describe("rate details section", () => {
        it("displays interest rate", () => {
            ...
            expect(screen.getAllByText("Interest Rate").length).toBeGreaterThan(
                0,
            );
    ...
    describe("follow-on period section", () => {
        ...
        it("does not display follow-on section for variable rates", () => {
            ...
            expect(
                screen.queryByText("Follow-On Period"),
    ...
    describe("end of fixed period section", () => {
        it("displays remaining balance for fixed rates", () => {
            ...
            expect(
                screen.getByText("At End of Fixed Period"),
            ).toBeInTheDocument();
    ...
    describe("term selector", () => {
        ...
        it("has interactive term tabs", async () => {
            ...
            if (tabs.length > 1) {
                ...
                await waitFor(() => {
                    expect(screen.getAllByRole("tab").length).toBeGreaterThan(
                        0,
                    );
                });
            }
    ...
    describe("modal behavior", () => {
        it("calls onOpenChange when close button is clicked", async () => {
            ...
            render(
                <RateInfoModal {...defaultProps} onOpenChange={onOpenChange} />,
            );
