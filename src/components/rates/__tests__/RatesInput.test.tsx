...
describe("RatesInput", () => {
    ...
    describe("first mortgage mode", () => {
        it("renders property value input", () => {
            ...
            expect(
                screen.getByLabelText(/property value/i),
            ).toBeInTheDocument();
        });
        ...
        it("renders mortgage amount input", () => {
            ...
            expect(
                screen.getByLabelText(/mortgage amount/i),
            ).toBeInTheDocument();
        });
        ...
        it("renders buyer type selector", () => {
            ...
            expect(
                screen.getAllByLabelText(/buyer type/i).length,
            ).toBeGreaterThan(0);
        });
    ...
    describe("remortgage mode", () => {
        ...
        it("shows Outstanding Balance label", () => {
            ...
            expect(
                screen.getByLabelText(/outstanding balance/i),
            ).toBeInTheDocument();
        });
        ...
        it("shows current monthly repayment input instead of deposit", () => {
            ...
            expect(
                screen.queryByLabelText(/^deposit$/i),
            ).not.toBeInTheDocument();
        });
        ...
        it("shows current lender selector", () => {
            ...
            expect(
                screen.getByLabelText(/current lender/i),
            ).toBeInTheDocument();
        });
        ...
        it("shows Remaining Term label", () => {
            ...
            expect(
                screen.getByLabelText(/remaining term/i),
            ).toBeInTheDocument();
        });
    ...
    describe("LTV quick select buttons", () => {
        it("renders LTV percentage buttons", () => {
            ...
            expect(
                screen.getByRole("button", { name: "50%" }),
            ).toBeInTheDocument();
            expect(
                screen.getByRole("button", { name: "70%" }),
            ).toBeInTheDocument();
            expect(
                screen.getByRole("button", { name: "80%" }),
            ).toBeInTheDocument();
            expect(
