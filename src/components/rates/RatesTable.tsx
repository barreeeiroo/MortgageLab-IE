...
function createColumns(
    ...
    return [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                const allPerks = resolvePerks(
                    perks,
                    row.original.combinedPerks,
                );
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                const currentMonthly = parseCurrency(
                    inputValues.monthlyRepayment,
                );
                const delta =
                        ...
                        return (
                            <Tooltip>
                                ...
                                <TooltipContent className="max-w-xs">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Add a custom variable rate with matching
                                        criteria (lender, LTV range, BER
                                        eligibility) to see follow-on
                                        calculations.
                                    </p>
                                </TooltipContent>
                            </Tooltip>
                    ...
                    return (
                        <Tooltip>
                            ...
                            <TooltipContent className="max-w-xs">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Could not find a matching variable rate for
                                    this fixed product. Click to report this
                                    issue.
                                </p>
                            </TooltipContent>
                        </Tooltip>
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="text-right text-muted-foreground">
                        <p>
                            {monthlyFollowOn
                                ? formatCurrency(monthlyFollowOn)
                                : "—"}
                        </p>
                        {delta !== null && delta !== 0 && (
                            <p
                        ...
                        {hasWarning && (
                            <Tooltip>
                                ...
                                <TooltipContent className="max-w-xs">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        No matching follow-on variable rate was
                                        found. This calculation assumes the
                                        fixed rate continues for the entire
                                        term.
                                    </p>
                                </TooltipContent>
                            </Tooltip>
                    ...
                    return (
                        <div className="flex justify-center">
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p>
                                        Select {MIN_COMPARE_RATES} or more rates
                                        to compare
                                    </p>
                                </TooltipContent>
                            </Tooltip>
                    ...
                    return (
                        <div className="flex justify-center">
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p>
                                        Maximum of {MAX_COMPARE_RATES} rates can
                                        be compared
                                    </p>
                                </TooltipContent>
                            </Tooltip>
    ...
    const data = useMemo<RateRow[]>(
        () =>
            rates.map((rate) => {
                ...
                const combinedPerks = [
                    ...new Set([...lenderPerkIds, ...rate.perks]),
                ];
                ...
                if (
                    ...
                    const rateAprcFees = (rate as { aprcFees?: AprcFees })
                        .aprcFees;
    ...
    return (
        <>
            ...
            <RateInfoModal
                ...
                lender={
                    selectedRate
                        ? getLender(lenders, selectedRate.lenderId)
                        : undefined
                }
                allRates={allRates}
                perks={perks}
