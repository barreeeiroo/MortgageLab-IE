...
describe("ManageCustomPerksDialog", () => {
    ...
    describe("basic rendering", () => {
        ...
        it("renders description text", () => {
            ...
            expect(
                screen.getByText(/manage your custom perks/i),
            ).toBeInTheDocument();
        });
    ...
    describe("empty state", () => {
        it("shows empty message when no perks", () => {
            ...
            expect(
                screen.getByText(/no custom perks yet/i),
            ).toBeInTheDocument();
        });
    ...
    describe("delete confirmation", () => {
        ...
        it("shows perk label in confirmation", async () => {
            ...
            await waitFor(() => {
                expect(
                    screen.getByText(/"Free Legal Fees"/),
                ).toBeInTheDocument();
            });
        });
    ...
    describe("back button", () => {
        it("renders back button when onBack provided", () => {
            render(
                <ManageCustomPerksDialog {...defaultProps} onBack={vi.fn()} />,
            );
        ...
        it("calls onBack when back button is clicked", async () => {
            ...
            const onBack = vi.fn();
            render(
                <ManageCustomPerksDialog {...defaultProps} onBack={onBack} />,
            );
