...
export function ManageCustomPerksDialog({
    ...
    const [editingPerk, setEditingPerk] = useState<StoredCustomPerk | null>(
        null,
    );
                            ...
                            <div className="flex items-start justify-between gap-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <DialogDescription>
                                            Manage your custom perks for use
                                            with custom rates.
                                        </DialogDescription>
                                    </div>
                                </div>
                        ...
                        {customPerks.length === 0 ? (
                            <div className="px-6 py-12 text-center text-muted-foreground">
                                ...
                                <p className="text-xs mt-1">
                                    Add a custom perk to use with your custom
                                    rates.
                                </p>
                            </div>
                        ) : (
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            {deleteConfirmPerk?.label}"? This action cannot be
                            undone. Custom rates using this perk will no longer
                            display it.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
