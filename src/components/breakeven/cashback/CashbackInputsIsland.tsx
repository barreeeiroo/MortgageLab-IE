...
export function CashbackInputsIsland() {
    ...
    const addOption = useCallback(() => {
        ...
        setOptions((prev) => [
            ...prev,
            createOption(`Option ${prev.length + 1}`),
        ]);
    }, [options.length]);
    ...
    const isOptionValid = (opt: CashbackOptionFormState) => {
        ...
        const hasCashbackValue =
            opt.cashbackValue !== "" &&
            Number.parseFloat(opt.cashbackValue) >= 0;
        ...
        <Card>
            <CardContent>
                <div className="mb-6">
                    ...
                    <CardDescription>
                        Compare mortgages with different rates and cashback
                        offers to find the cheapest option over time.
                    </CardDescription>
                </div>
                ...
                <div className="grid gap-3 sm:grid-cols-3 sm:items-end">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                onUpdate({
                                    cashbackCap: e.target.value.replace(
                                        /[^0-9]/g,
                                        "",
                                    ),
                                })
