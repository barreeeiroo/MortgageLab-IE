...
describe("CashbackResultCard", () => {
    ...
    describe("winner summary", () => {
        it("displays the best option label", () => {
            ...
            expect(
                screen.getByText(/Best Option: Option A/i),
            ).toBeInTheDocument();
        });
    ...
    describe("comparison period info", () => {
        ...
        it("displays full term for all variable rates", () => {
            ...
            render(
                <CashbackResultCard {...defaultProps} result={allVariable} />,
            );
    ...
    describe("metric rows", () => {
        it("displays Adjusted Balance section", () => {
            ...
            expect(
                screen.getAllByText("Adjusted Balance").length,
            ).toBeGreaterThan(0);
            // The description also appears multiple times (in details summary)
            expect(
                screen.getAllByText(
                    /Balance if cashback was applied to principal/i,
                ).length,
            ).toBeGreaterThan(0);
        });
        ...
        it("displays Balance After section", () => {
            ...
            expect(
                screen.getByText(
                    /Remaining mortgage balance after comparison period/i,
                ),
            ).toBeInTheDocument();
        });
    });
    ...
    describe("breakeven points", () => {
        ...
        it("displays individual breakeven comparisons", () => {
            ...
            expect(
                screen.getByText(/Option A vs Option B:/i),
            ).toBeInTheDocument();
        ...
        it("does not display breakeven section when no breakevens", () => {
            ...
            render(
                <CashbackResultCard {...defaultProps} result={noBreakeven} />,
            );

            expect(
                screen.queryByText("Breakeven Points"),
    ...
    describe("overpayment allowances", () => {
        it("displays overpayment allowances when provided", () => {
            ...
            expect(
                screen.getByText(/Overpayment Allowances/i),
            ).toBeInTheDocument();
        ...
        it("shows breakage fee warning for options without policy", () => {
            ...
            expect(screen.getAllByText("Breakage fee").length).toBeGreaterThan(
                0,
            );
        });
    });
    ...
    describe("three option comparison", () => {
        it("handles three options correctly", () => {
            ...
            render(
                <CashbackResultCard {...defaultProps} result={threeOptions} />,
            );
